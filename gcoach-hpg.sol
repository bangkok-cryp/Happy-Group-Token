...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x14d665636b30faf16634ca85cd776719fcc82224;
...
contract HPG is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xE80757217f9795f0214f7AB94bC0f612424C99D1;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 500000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Happy Group Token";
    string private _symbol = "HPG";
